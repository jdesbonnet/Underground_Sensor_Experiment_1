...
set output "radio-rssi-snr-recent.png"
...
set xrange ["20180101-0000":*]
plot '../data/ugsensor.dat' using 1:3 with lines lw 1 title "RSSI", '' using 1:4 with lines lw 1 title 'SNR dB', \
